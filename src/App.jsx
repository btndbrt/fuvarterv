...
export default function App() {
  ...
  /* The Monday (ISO) of the week whose driver sheet is open for printing, or null.
     Held here rather than in the schedule screen because the overlay has to be a
     direct child of .ft-root: the print stylesheet hides the header, the tabs and
     <main>, and the sheet has to survive that. */
  const [printWeek, setPrintWeek] = useState(null);
  ...
  useEffect(() => {
    const onPrint = (e) => setPrintWeek(e.detail?.weekMonISO || null);
  ...
  return (
    <div className="ft-root">
      ...
      {printWeek && <PrintSheets state={state} weekMonISO={printWeek} onClose={() => setPrintWeek(null)} />}
